      ...
      <div className={styles.grid}>
        <article>
          ...
          <p>
            ...
            realtime technologies like{' '}
            <a href="https://socket.io/">socket.io</a> or{' '}
        ...
        <article>
          ...
          <p>
            Express relationships using <Link to="docs/joins">joins</Link>,
            build <Link to="docs/geo">location-aware apps</Link>, or store{' '}
            <Link to="docs/binary">multimedia</Link> and{' '}
            <Link to="docs/dates-and-times">time-series data</Link>. Do
            analytics with{' '}
            <Link to="docs/map-reduce">aggregation and map/reduce</Link>, and
        ...
        <article>
          ...
          <p>
            Developed by a core team of database experts and over 100
            contributors from around the world, RethinkDB is shaped by
            developers like you participating in{' '}
